        ...
        <div style={{ backgroundColor: 'white' }}>
            ...
            <TextField id="standard-basic" label="Cost" variant="standard" name="cost" value={cost} onChange={(event) => textfieldChange(event)}/>
                <Grid container>
                    ...
                    <Button variant="contained" type="submit" onClick={() => {handleClick(); setIsUpdating(false); setRenderDelete(true)}}>Submit</Button>
                        </Grid>
            </Grid>
            <Button variant="contained" onClick={() => {setIsUpdating(false); setRenderDelete(true)}}>Back</Button>
        </div>
    )
};
